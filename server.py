...
def classify(message: str) -> str:
    cat = ask(
        ...
        "«общее» — всё остальное.\n"
        "\n"
        "ВАЖНО. Вопрос про натальную карту, гороскоп, асцендент, знак зодиака, "
        "транзиты или про страницу «Эфемерида» — это НЕ «гадание», а «общее». "
        "У студии есть такая страница, и про неё надо рассказать, а не уводить "
        "человека в книжное гадание. «Гадание» — только когда человек сам просит "
        "погадать по книге или назвать числа.\n"
