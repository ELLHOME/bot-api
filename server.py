...
LAB_PICK_NAMES = (
    "\n\nПеред тобой запрос и черновой список названий. Выбери ТРИ — "
    "и обязательно разных по принципу, а не три вариации одного.\n"
    "ГЛАВНЫЙ КРИТЕРИЙ: бери не самое разумное, а самое запоминающееся. "
    "Если вариант заставляет улыбнуться или сначала царапает, а потом нравится — "
    "он сильнее гладкого и безопасного. Гладкие выброси первыми.\n"
